...
BFEDevice::BFEDevice(BFEWindow &window) : window{window} {
  createInstance();
  setupDebugMessenger();
  createSurface();
  pickPhysicalDevice();
...
void BFEDevice::pickPhysicalDevice() {
...
bool BFEDevice::isDeviceSuitable(VkPhysicalDevice device) {
...
void BFEDevice::populateDebugMessengerCreateInfo(
...
void BFEDevice::setupDebugMessenger() {
...
bool BFEDevice::checkValidationLayerSupport() {
  uint32_t layerCount;
...
std::vector<const char *> BFEDevice::getRequiredExtensions() {
...
void BFEDevice::hasGflwRequiredInstanceExtensions() {
...
bool BFEDevice::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices BFEDevice::findQueueFamilies(VkPhysicalDevice device) {
...
SwapChainSupportDetails BFEDevice::querySwapChainSupport(VkPhysicalDevice device) {
...
VkFormat BFEDevice::findSupportedFormat(
...
uint32_t BFEDevice::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
