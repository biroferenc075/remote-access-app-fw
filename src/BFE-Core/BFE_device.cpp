...
BFEDevice::BFEDevice(BFEWindow &window) : BFEDeviceBase{window} {
...
void BFEDevice::createSurface() { dynamic_cast<BFEWindow&>(window).createWindowSurface(instance, &surface_); }
